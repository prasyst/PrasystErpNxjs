...
//   const autoRestartScannerRef = useRef(false);
...
//         if (!error.includes('NotFoundException') && !error.includes('MultiFormat')) {
...
//     // Auto restart scanner if enabled
//     if (autoScanMode) {
//       // Close the scanner if it's open, then reopen after a delay
//       if (showScanner) {
//         stopScanner();
//         setTimeout(() => {
//           startScanner();
