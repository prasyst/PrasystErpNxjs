...
import {
  Box, Grid, TextField, Typography, Button, Stack, FormControlLabel, FormLabel, Radio, Link, RadioGroup, Checkbox,
} from '@mui/material';
  ...
  return (
    <>
      <Grid container spacing={0.5}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 2 }} sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <Button
            component="span"
            variant="contained"
            sx={{
