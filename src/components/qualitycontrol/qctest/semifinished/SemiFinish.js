...
import PrintSemiFinish from './PrintSemiFinish';
...
const SemiFinish = () => {
    ...
    const moduleName = 'QC SemiFinish';
    ...
    const handleTable = () => {
        router.push("/qualitycontrol/qctest/semifinished/semiftable");
    };
    ...
    const handlePrint = async () => {
        try {
            ...
            if (STATUS === 0 && Array.isArray(DATA)) {
                ...
                const asPdf = pdf(<PrintSemiFinish rows={formattedData} />);
