...
import PrintParamtr from './PrintParamtr';
...
const QcParamtr = () => {
    ...
    const handleTable = () => {
        router.push("/qualitycontrol/qcparameter/qcparatable/");
    };
    ...
    const handlePrint = async () => {
        try {
            ...
            if (STATUS === 0 && Array.isArray(DATA)) {
                ...
                const asPdf = pdf(<PrintParamtr rows={formattedData} />);
    ...
    return (
        <Grid container sx={{ bgcolor: '#f5f5f5', py: 4 }}>
            ...
            <Grid item xs={12} sx={{ mx: 'auto', px: { xs: 4, sm: 6, md: 8, lg: 12 }, width: '100%' }}>
                ...
                <TableContainer sx={{ minHeight: 200, maxHeight: 300, overflowY: 'auto', mt: 1, width: '100%', borderRadius: 4 }}>
                    <Table stickyHeader size="medium" sx={{ width: '100%', border: '1px solid #ddd', borderRadius: 2 }}>
                        <TableHead>
                            <TableRow sx={{ backgroundColor: '#f0f0f0' }}>
                                ...
                                <TableCell sx={{ ...commonCellSx, fontWeight: 'bold', width: '30%' }}>Remark</TableCell>
