...
//       //   minHeight: '100vh',
//       //   display: 'flex',
//       //   background: 'linear-gradient(135deg, #1f1c2c 0%, #3A7BD5 100%)',
...
//                   </Box>
//                 </Box>
//                 {/* <Typography variant="h4" fontWeight="700" mt={2} color="#333">
//                   Sign In
//                 </Typography>
//                 <Typography variant="body2" sx={{ color: '#3A7BD5', fontWeight: 600, mt: 0.5 }}>
//                   as {role.toUpperCase()}
//                 </Typography> */}
//               </Box>
...
//                   <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2.5, flexDirection: isMobile ? 'column' : 'row' }}>
