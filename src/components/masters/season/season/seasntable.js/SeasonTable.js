...
const handsontableColumns = [
    ...
    { field: "SEASON_KEY", headerName: "Code", width: "16%", type: "text" },
     { field: "SEASON_NAME", headerName: "Name", width: "25%", type: "text" },
    { field: "SEASON_ABRV", headerName: "Abrv", width: "15%", type: "text" },
    { field: "CURR_SEASON", headerName: "CURR_SEASON", width: "25%", type: "text" },
...
export default function SeasonTable() {
    ...
    const handleRowClick = (row) => {
        ...
        router.push(`/masters/season/season?${params}`);
    };
            ...
            <div className="w-full mx-auto" style={{ maxWidth: '100%' }}>
                <div className="mb-4 flex flex-wrap gap-4 items-center">
                    <Button
                        ...
                        sx={addButtonStyles}
                        startIcon={<AddIcon />}
                        onClick={() => router.push('/masters/season/season')}
                    >
                        New
                    </Button>
                </div>
