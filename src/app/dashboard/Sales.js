          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card sx={{ backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
              <CardContent sx={{ textAlign: 'center', padding: '32px' }}>
                <Image
                  src="https://blogv2new.clickfunnels.com/wp-content/uploads/2022/06/1-29.jpg"
                  alt="Stock"
                  height={100}
                  width={200}
                />
                ...
                <Typography variant="body2" color="textSecondary">
                  We&apos;re working hard to bring you the latest sales updates and promotions. Stay tuned for exciting offers and new products!
                </Typography>
              </CardContent>
            </Card>
          </Grid>
