...
const handsontableColumns = [
 // { field: "ROWNUM", headerName: "SrNo", width: "16%", type: "numeric" },
    { field: "TERM_KEY", headerName: "Code", width: "16%", type: "text" },
    { field: "TERM_ALT_CODE", headerName: "ALTCode", width: "25%", type: "text" },
    { field: "TERM_NAME", headerName: "Name", width: "25%", type: "text" },
    { field: "TERM_ABRV", headerName: "Abrv", width: "15%", type: "text" },
            ...
            <div className="w-full mx-auto" style={{ maxWidth: '100%' }}>
                <div className="mb-4 flex flex-wrap gap-4 items-center">
                    <Button
                        ...
                        sx={addButtonStyles}
                        startIcon={<AddIcon />}
                        onClick={() => router.push('/masters/taxterms/termmaster')}
                    >
                        New
                    </Button>
                </div>
