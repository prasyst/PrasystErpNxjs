...
import PrintStores from './PrintStores';
...
const Stores = () => {
        ...
        const fetchPartyDrp = async () => {
            try {
                ...
                if (STATUS === 0 && Array.isArray(DATA)) {
                    ...
                    setForm((prev) => ({
                        ...prev, PARTY_KEY: validParty[12]?.PARTY_KEY
                    }));
                } else {
                    setPartyDrp([]);
                }
    ...
    const handleTable = () => {
        router.push("/qualitycontrol/qctest/stores/storestable");
    };
    ...
    const handlePrint = async () => {
        try {
            ...
            if (STATUS === 0 && Array.isArray(DATA)) {
                ...
                const asPdf = pdf(<PrintStores rows={formattedData} />);
