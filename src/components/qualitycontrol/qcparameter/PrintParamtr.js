...
const PrintParamtr = ({ rows, currentCatData }) => {
                ...
                <View style={{ marginTop: 30, marginBottom: 20 }} >
                    ...
                    <View style={{ border: '1px solid #000', borderRadius: 3, marginBottom: 10 }}>
                        <View style={{
                            ...
                            <Text style={{ width: '40%', borderRight: '1px solid #ddd', padding: 5 }}>SubGrpName</Text>
                            <Text style={{ width: '25%', borderRight: '1px solid #ddd', padding: 5 }}>TestNm</Text>
                            <Text style={{ width: '13%', borderRight: '1px solid #ddd', padding: 5 }}>ValTest</Text>
                        ...
                        {rows.map((row, index) => (
                            <View key={row.QC_PM_ID} style={{
                                ...
                                <Text style={{ width: '40%', borderRight: '1px solid #ddd', padding: 5 }}>{row.QC_SUBGROUP_NAME}</Text>
                                <Text style={{ width: '25%', borderRight: '1px solid #ddd', padding: 5 }}>{row.TEST_NAME}</Text>
                                <Text style={{ width: '13%', borderRight: '1px solid #ddd', padding: 5 }}>{row.VALUE_TEST}</Text>
